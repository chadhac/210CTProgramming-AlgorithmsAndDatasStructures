...
def square(self, a):
    ...
    if a >= 0:
        ...
        if answer*answer != a:  # this if statement was nested inside the while
...
a = 9 #CHANGE this to get for a different value and it will tell you if it's a square e.g. 9 is a square but 15 isn't          
